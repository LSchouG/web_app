...
import './NavBar.css'; 
import diagonalImage from '../Assest/diagonal.jpg'; // Note: 'Assest' might be a typo; assuming it's 'Assets'
    ...
    <div className={`navbar menu ${menuOpen ? 'active' : ''}`}>
      ...
      <nav className="nav-menu">
        <ul className="menu-links inline">
          <li onClick={() => {setMenu("forside")}}><Link to='/'>Forside</Link></li>
          <li onClick={() => {setMenu("portfolio")}}><Link to='/portfolio'>Portefølje</Link></li>
          <li onClick={() => {setMenu("om mig")}}><Link to='/about'>Om mig</Link></li>
          <li onClick={() => {setMenu("services")}}><Link to='/services'>Services</Link></li>
          <li className="dropdown-only" onClick={() => {setMenu("prisliste")}}><Link to='/prices'>Prisliste</Link></li>
          <li className="dropdown-only" onClick={() => {setMenu("kontakt")}}><Link to='/contact'>Kontakt</Link></li>
          <li className="dropdown-only" onClick={() => {setMenu("login")}}><Link to='/login'>Login</Link></li>
        </ul>
        <ul 
